...
vtconsole_t *vtconsole(int width, int height, vtc_paint_handler_t on_paint, vtc_cursor_handler_t on_move, bool is_verbose_boot)
{
    vtconsole_t *vtc = (vtconsole_t*)sizeof(vtconsole_t);
    ...
    vtc->buffer = fb_1080x1920_screen_malloc(width * height * sizeof(vtcell_t));
